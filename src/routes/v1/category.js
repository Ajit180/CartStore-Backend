...
router.get('/get/:id',isAuthenticated,authorizeRoles('customer'),getCategoryByIdController);
router.get('/getall',isAuthenticated,authorizeRoles('customer'),getCategoryAllController);
